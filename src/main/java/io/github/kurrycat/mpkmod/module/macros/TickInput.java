...
public class TickInput implements Copyable<TickInput> {
    ...
    public TickInput(boolean W, boolean A, boolean S, boolean D, boolean P, boolean N, boolean J, int L, int R, float YAW, float PITCH) {
    ...
    public TickInput(int keyInputs, int L, int R, float YAW, float PITCH) {
